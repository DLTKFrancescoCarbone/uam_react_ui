...
const CompanySetupPage = () => {
  ...
  const isButtonDisabled = !companyName.trim();

  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      {/* Complete SVG Background - using the exact Company.svg as background */}
            ...
            backgroundImage: `url("data:image/svg+xml,${encodeURIComponent(`
              <svg width="1728" height="1117" viewBox="0 0 1728 1117" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1_7227)">
                  ...
                  <path d="M-148.22 1167L35.693 983.087H-13.1951L-197.108 1167H-148.22Z" fill="black" fill-opacity="0.12"/>
                  <path d="M-63.2463 1167L120.666 983.087H71.7781L-112.134 1167H-63.2463Z" fill="black" fill-opacity="0.12"/>
                  <path d="M1356.84 435.974C1378.22 435.974 1388.92 461.825 1373.81 476.944L989.304 861.446C984.803 865.947 978.699 868.476 972.333 868.476H416.906C395.524 868.476 384.816 842.624 399.935 827.505L784.437 443.003C788.938 438.502 795.043 435.974 801.408 435.974H1356.84ZM1373.81 344.12C1388.93 359.239 1378.22 385.091 1356.84 385.091H801.409C795.044 385.091 788.939 382.562 784.438 378.061L399.936 -6.4406C384.817 -21.5598 395.525 -47.4111 416.907 -47.4111H972.334C978.699 -47.4111 984.804 -44.8826 989.305 -40.3817L1373.81 344.12Z" fill="black" fill-opacity="0.12"/>
                  <path d="M1682.41 84.6666L1478.71 -118.333C1473.66 -123.369 1477.23 -132 1484.36 -132H1561.95L1727.65 33.1258C1729.15 34.6269 1730 36.6659 1730 38.7924V79C1730 83.4183 1726.42 87 1722 87H1688.06C1685.94 87 1683.91 86.1609 1682.41 84.6666Z" fill="black" fill-opacity="0.12"/>
                  ...
                  <path d="M574.072 419.525L528 499.985L574.072 585.042" stroke="url(#paint1_linear_1_7227)" stroke-width="0.853178"/>
                  <path d="M1153.4 419.525L1199.47 499.985L1153.4 585.042" stroke="url(#paint2_linear_1_7227)" stroke-width="0.853178"/>
      ...
      {/* Form positioned exactly where it should be based on the SVG */}
      <div className="relative z-10 flex items-center justify-center w-full h-full">
        <div className="text-center -mt-16">
          {/* Deltek Logo - using the delteklogosvgwhite.svg */}
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-start">
              <Button 
                onClick={handleNext}
                size="sm"
                className="font-medium rounded btn-white"
